                ...
                <form action="{{route('posts.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-sm-6 control-group mb-4">
                            ...
                            {{-- <input type="text" class="form-control p-4" value="{{old('title')}}" name="category" placeholder="Category" > --}}
                        ...
                        <div class="col-sm-6 control-group mb-4">
                            ...
                            <select name="tags[]" multiple>
                                ...
                                @foreach ($tags as $tap )
                             <option value="{{$tap->id}}">{{$tap->name}}</option>
                             @endforeach        
                             </select>
                        </div>
                    ...
                    <div class="control-group mb-4">
                        <textarea class="form-control p-4" rows="1" name="short_content" placeholder="Short_content"  >{{old('short_content')}}</textarea>
                        @error('short_content')
                        <p class="help-block text-danger">{{$message}}</p>
                        @enderror
