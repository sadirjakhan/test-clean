            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        ...
                        <div class="d-flex mb-2">
                            <a class="text-dark bg-secondary text-uppercase font-weight-medium"
                    ...
                    <div class="mb-5">
                        <h3 class="mb-4 section-title">{{ $post->comments()->count() }} Izoh Qoldirish</h3>
                    ...
                    <div class="bg-light rounded p-5">
                        ...
                        <div>Izoh qoldirish uchun 
                            ...
                            <div class="d-grid gap-2 d-md-block">
                                <a href="{{route('register')}}" class="btn btn-primary"   type="submit"> Rouhatdan oting</a>
                              </div>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="d-flex flex-wrap m-n1">
                            @foreach ($tags as $tak)
                                <a href="" class="btn btn-outline-secondary m-1">{{ $tak->name }}</a>
                            @endforeach
